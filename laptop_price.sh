...
headphone="boAt Bluetooth Headset Fiery Red"
...
headphone_url="https://www.flipkart.com/boat-bluetooth-headset/p/itmacb88c86754ff?qH=1d591c38b161e78f"
...
do
	...
	[[ $(dunstify -t 10000 -u "normal" "$headphone" "$headphone_price" -A Y," Open") = Y ]] && xdg-open "$headphone_url" &
